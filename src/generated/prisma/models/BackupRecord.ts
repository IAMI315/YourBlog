...
export type BackupRecordGroupByOutputType = {
  ...
  startedAt: Date
  completedAt: Date | null
  includedData: runtime.JsonValue
  archiveSize: bigint | null
...
export type BackupRecordWhereInput = {
  ...
  includedData?: Prisma.JsonFilter<"BackupRecord">
  archiveSize?: Prisma.BigIntNullableFilter<"BackupRecord"> | bigint | number | null
  status?: Prisma.EnumBackupStatusFilter<"BackupRecord"> | $Enums.BackupStatus
  safeErrorMessage?: Prisma.StringNullableFilter<"BackupRecord"> | string | null
}
...
export type BackupRecordOrderByWithRelationInput = {
  ...
  includedData?: Prisma.SortOrder
  archiveSize?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type BackupRecordScalarWhereWithAggregatesInput = {
  ...
  includedData?: Prisma.JsonWithAggregatesFilter<"BackupRecord">
  archiveSize?: Prisma.BigIntNullableWithAggregatesFilter<"BackupRecord"> | bigint | number | null
  status?: Prisma.EnumBackupStatusWithAggregatesFilter<"BackupRecord"> | $Enums.BackupStatus
  safeErrorMessage?: Prisma.StringNullableWithAggregatesFilter<"BackupRecord"> | string | null
}
...
export type BackupRecordCreateInput = {
  ...
  includedData: Prisma.JsonNullValueInput | runtime.InputJsonValue
  archiveSize?: bigint | number | null
  status?: $Enums.BackupStatus
  safeErrorMessage?: string | null
}
...
export type BackupRecordUpdateInput = {
  ...
  includedData?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  archiveSize?: Prisma.NullableBigIntFieldUpdateOperationsInput | bigint | number | null
...
export type BackupRecordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "startedAt" | "completedAt" | "includedData" | "archiveSize" | "status" | "safeErrorMessage", ExtArgs["result"]["backupRecord"]>
...
export interface BackupRecordFieldRefs {
  ...
  readonly includedData: Prisma.FieldRef<"BackupRecord", 'Json'>
  readonly archiveSize: Prisma.FieldRef<"BackupRecord", 'BigInt'>
  readonly status: Prisma.FieldRef<"BackupRecord", 'BackupStatus'>
  readonly safeErrorMessage: Prisma.FieldRef<"BackupRecord", 'String'>
}
